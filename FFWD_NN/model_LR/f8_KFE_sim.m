...
function [KFE_sim] = f8_KFE_sim(KFE_inputs)
    ...
    for t=1:KFE_inputs.each_sim
        ...
        % This ensures that the simulation is bounded within the limits
        ...
        wB=(KFE_inputs.B_grid(BposU(t))-Bsim(t))/KFE_inputs.dB; % Definition of the weights
        ...
        wN=(KFE_inputs.N_grid(NposU(t))-Nsim(t))/KFE_inputs.dN;
